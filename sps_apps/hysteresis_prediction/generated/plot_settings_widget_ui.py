...
class Ui_PlotSettingsWidget(object):
    def setupUi(self, PlotSettingsWidget):
        ...
        self.gridLayout.addWidget(self.labelCycleTime, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelCycle, 0, 0, 1, 1)
        self.Led = Led(self.frame_2)
        self.Led.setToolTip("")
        self.Led.setProperty("status", Led.Off)
        self.Led.setObjectName("Led")
        self.gridLayout.addWidget(self.Led, 0, 1, 3, 1)
    ...
    def retranslateUi(self, PlotSettingsWidget):
        ...
        self.labelCycleTime.setText(_translate("PlotSettingsWidget", "2023-01-01 16:03:01"))
        self.label_3.setText(_translate("PlotSettingsWidget", "???"))
        self.labelCycle.setText(_translate("PlotSettingsWidget", "SFTPRO1"))
        ...
        self.pushButton.setText(_translate("PlotSettingsWidget", "Start Prediction"))
