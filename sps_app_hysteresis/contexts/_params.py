...
MBI_PARAMS = ParameterNames(
    ...
    I_PROG_DYNECO="rda3://UCAP-NODE-SPS-HYSTCOMP/UCAP.MBI/DYNECO_IREF",
    I_PROG_FULLECO="rda3://UCAP-NODE-SPS-HYSTCOMP/UCAP.MBI/FULLECO_IREF",
    FULLECO_TRIGGER="XTIM.SX.FCY-MMODE-WRT/Acquisition",
    I_MEAS="MBI/LOG.I.MEAS",
    B_MEAS="UCAP.BTRAIN.BMEAS.SP/Acquisition#value",
